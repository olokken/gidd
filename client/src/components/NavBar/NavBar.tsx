import { AppBar, Button, Icon, Toolbar, MenuItem, makeStyles, ListItem, Drawer } from '@material-ui/core';
        ...
        const getDrawerChoices = () => {
            return (
                <div style={{display:"flex", flexDirection:"column", justifyContent:"space-between"}}>
                    <br/>
                    <Button style={{padding:"10px"}} onClick={changeToHomePageDrawer}><DirectionsRunIcon/>Aktiviteter</Button>
                    <Button style={{padding:"10px"}} onClick={changeToMapDrawer}><MapIcon/>Kart</Button>
                    <Button style={{padding:"10px"}} onClick={changeToCalenderDrawer}> <CalendarTodayIcon/> Kalender</Button>
                    <Button style={{padding:"10px"}} onClick={changeToGroupsAndFriendsDrawer}><PeopleIcon/>Grupper og venner</Button>
                    <Button style={{padding:"10px"}} onClick={changeToLeaderboardDrawer}><EmojiEventsIcon/>Leaderboard</Button>  
                </div>  
            )
        };
            ...
            {notifications.map((notification,index) => {
                return(
                    <StyledMenuItem style={{
                            ...
                            textAlign:'center',
                            width:'300px',
                            fontSize:'15px'}} key={index} onClick={handleCloseMenu}>
                        <div >
